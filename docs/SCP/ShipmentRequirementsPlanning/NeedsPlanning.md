...
После обновления на вкладке **"Отгрузки"** будет отражена потребность в отгрузке за выбранный период. Данные выводятся в разрезе номенклатуры, характеристики, склада, волны отгрузки и даты выпуска.

Детализацию до характеристики, склада и волны можно отключить в [**сценарии планирования потребностей**](NeedsPlanningScenarios.md) или настройках АРМа. Отключение детализации до характеристики, склада или волны в настройках не влияет на расчет данных и вытеснение компонент, меняется только внешнее отображение данных. Например, если отключена детализация до характеристик и есть предварительный заказ с характеристикой "Ашан" и характеристикой "Лента", при этом есть фактический заказ с характеристикой "Лента", то тогда, согласно приоритетам вытеснения компонент, фактический заказ вытеснит предварительный заказ по характеристике "Лента". В плане потребностей будет выведена сумма предварительного заказа по характеристике "Ашан" и фактического заказа по характеристике "Лента" (так как фактический заказ вытеснил предварительный).
...
- Заполнить план по правилу – план заполняется согласно [**правилу расчета отгрузок**](RulesForCalculatingShipments.md), указанного для текущей товарной категории, группы планирования и горизонта планирования. Если по товарной категории не задано ни одного правила, то план заполняется по фактическими заказами;
...
- В отчете **Прогноз потребностей** выводится результат планирования отгрузок, показаны данные по прогнозу, предварительным и фактическим заказам за период планирования из АРМа.

[![25][25]][25]

- Отчет **Статистика отгрузок** позволяет анализировать статистику по заказам за период планирования и сравнивать насколько изменилось количество в заказе относительно исходного количества.

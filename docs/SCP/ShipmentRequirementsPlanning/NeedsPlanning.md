...
После выбора варианта заполнения нужно выбрать строки для заполнения, а затем нажать кнопку **"Выполнить"**, будет заполнена колонка 
План в таблице. Если в карточке номенклатуры была указана кратность, а число в колонке План в результате вытеснения данных рассчитывается не кратным, то оно всегда округляется по кратности номенклатуры в большую сторону. 
...
Для формирования плана потребностей нужно нажать кнопку **"Сохранить"**, система подставит его в поле "Сохраненный план". Если меняем уже существующий, то выбираем его из списка в поле "Сохраненный план", вносим изменения и также нажимаем кнопку **"Сохранить"**.
